      ...
      <form className="form form--filter">
        ...
        <div className="form__group" onChange={(event) => onSetFloorParam(event.target.value)}>
          <div className="form_group">
            <input type="radio" value="CS 1" name="floor-select" className="form__input--radio" checked={floorParam === 'CS 1' ? true : false}/>
            <label for="floor8" className="form__label form__label--inline">CS 1</label>
          </div>
          <div className="form_group">
            <input type="radio" value="CS 2" name="floor-select" className="form__input--radio" checked={floorParam === 'CS 2' ? true : false}/>
            <label for="floor13" className="form__label form__label--inline">CS 2</label>
          </div>
          <div className="form_group">
