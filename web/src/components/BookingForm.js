  ...
  return (
    <Fragment>
      <div className="header__page">
        <h2 className="header__heading header__heading--sub">Building {roomData.floor} | {roomData.name}</h2>
      </div>
      <form className="form__grid form--booking" onSubmit={event => {
        ...
        <div className="content__form">
          ...
          <div className="form__group">
            <label className="form__label form__label--booking">
              {'Course'}
              <select name="business" defaultValue="Course" className="form__input form__input--select">
                ...
                <option value="CS259">CS259</option>
              </select>
            </label>
          </div>
          <div className="form__group">
