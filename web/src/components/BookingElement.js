...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, 'Asia/Kuala_Lumpur').format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, 'Asia/Kuala_Lumpur').format('h.mma')
  ...
  return (
    <div className="booking__box">
      ...
      <div className="booking__innerbox--middle">
        ...
        <p>Building {roomInfo.floor}, {roomInfo.name}</p>
      </div>
